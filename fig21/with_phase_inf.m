...
% 渐进稳态解Cxt
eps=zeros(size(t)); 
omega_j = 1.0355383042373671; %对应于论文中的omega_j
s_j = -1i*omega_j;
cx0 = sqrt(0.8);
ce0 = sqrt(0.2);
...
title('with phase $4\pi/3$', Interpreter='latex');
...
dxdt = [-1i*mu_1*epsilon(1)-1i*G*epsilon(2)+s1;
...
function result = cxtfun(tau0,N1,G,gamma,omegal,mu1,mu2,alpha,cx0,ce0,s)
    ...
    us1 = sqrt(-1).*mu1+s+(1/8).*exp(1).^((sqrt(-1)*(-1)).*alpha.*(1+N1)+( ...
  -1).*(sqrt(-1).*omegal+(2+N1).*s).*tau0).*gamma.*(exp(1).^((sqrt( ...
  -1)*(1/2)).*(4.*alpha.*(1+N1)+(omegal+N1.*omegal+(sqrt(-1)*(-6)).* ...
  s).*tau0))+exp(1).^((sqrt(-1)*(1/2)).*(4.*alpha.*N1+3.*omegal.* ...
  tau0+N1.*omegal.*tau0+(sqrt(-1)*(-2)).*s.*tau0))+exp(1).^((sqrt( ...
  -1)*2).*alpha+(sqrt(-1)*(1/2)).*(3+N1).*omegal.*tau0+s.*tau0)+(-2) ...
  .*exp(1).^(sqrt(-1).*alpha+(sqrt(-1)*(1/2)).*(2+N1).*omegal.*tau0+ ...
  2.*s.*tau0)+(-2).*exp(1).^(sqrt(-1).*alpha.*(1+2.*N1)+(sqrt(-1)*( ...
  1/2)).*(2+N1).*omegal.*tau0+2.*s.*tau0)+exp(1).^((sqrt(-1)*(1/2)) ...
  .*(1+N1).*omegal.*tau0+3.*s.*tau0)+4.*exp(1).^(sqrt(-1).*alpha.*( ...
  1+N1)+sqrt(-1).*omegal.*tau0+(2+N1).*s.*tau0)+exp(1).^(sqrt(-1).* ...
  alpha.*N1+(sqrt(-1)*(3/2)).*omegal.*tau0+s.*tau0+N1.*s.*tau0).*(( ...
  -1)+N1)+exp(1).^(sqrt(-1).*alpha.*(2+N1)+(sqrt(-1)*(3/2)).* ...
  omegal.*tau0+(1+N1).*s.*tau0).*((-1)+N1)+exp(1).^(sqrt(-1).* ...
  alpha.*(1+N1)+(4+N1).*s.*tau0).*N1+(-1).*exp(1).^(sqrt(-1).* ...
  alpha.*(1+N1)+((sqrt(-1)*2).*omegal+N1.*s).*tau0).*N1+(-1).*exp(1) ...
  .^(sqrt(-1).*alpha.*N1+(sqrt(-1)*(1/2)).*omegal.*tau0+3.*s.*tau0+ ...
  N1.*s.*tau0).*(1+N1)+(-1).*exp(1).^(sqrt(-1).*alpha.*(2+N1)+(sqrt( ...
  -1)*(1/2)).*omegal.*tau0+(3+N1).*s.*tau0).*(1+N1)).*(cos(alpha)+( ...
  -1).*cos((1/2).*omegal.*tau0+sqrt(-1).*s.*tau0)).^(-2)+(sqrt(-1).* ...
  mu2+s).*(1+(-1/8).*exp(1).^((sqrt(-1)*(-1)).*alpha.*(1+N1)+(-1).*( ...
  sqrt(-1).*omegal+(2+N1).*s).*tau0).*gamma.*(2+N1).*(exp(1).^(( ...
  sqrt(-1)*(1/2)).*(4.*alpha.*(1+N1)+(omegal+N1.*omegal+(sqrt(-1)*( ...
  -6)).*s).*tau0))+exp(1).^((sqrt(-1)*(1/2)).*(4.*alpha.*N1+3.* ...
  ...
  tau0.*(cos(alpha)+(-1).*cos((1/2).*omegal.*tau0+sqrt(-1).*s.*tau0) ...
  ).^(-2)+(1/8).*exp(1).^((sqrt(-1)*(-1)).*alpha.*(1+N1)+(-1).*( ...
  sqrt(-1).*omegal+(2+N1).*s).*tau0).*gamma.*(3.*exp(1).^((sqrt(-1)* ...
  (1/2)).*(4.*alpha.*(1+N1)+(omegal+N1.*omegal+(sqrt(-1)*(-6)).*s).* ...
  tau0)).*tau0+exp(1).^((sqrt(-1)*(1/2)).*(4.*alpha.*N1+3.*omegal.* ...
  tau0+N1.*omegal.*tau0+(sqrt(-1)*(-2)).*s.*tau0)).*tau0+exp(1).^(( ...
  sqrt(-1)*2).*alpha+(sqrt(-1)*(1/2)).*(3+N1).*omegal.*tau0+s.*tau0) ...
  .*tau0+(-4).*exp(1).^(sqrt(-1).*alpha+(sqrt(-1)*(1/2)).*(2+N1).* ...
  omegal.*tau0+2.*s.*tau0).*tau0+(-4).*exp(1).^(sqrt(-1).*alpha.*(1+ ...
  2.*N1)+(sqrt(-1)*(1/2)).*(2+N1).*omegal.*tau0+2.*s.*tau0).*tau0+ ...
  3.*exp(1).^((sqrt(-1)*(1/2)).*(1+N1).*omegal.*tau0+3.*s.*tau0).* ...
  tau0+(-1).*exp(1).^(sqrt(-1).*alpha.*(1+N1)+((sqrt(-1)*2).*omegal+ ...
  N1.*s).*tau0).*N1.^2.*tau0+exp(1).^(sqrt(-1).*alpha.*(2+N1)+(sqrt( ...
  -1)*(3/2)).*omegal.*tau0+(1+N1).*s.*tau0).*((-1)+N1).*(1+N1).* ...
  tau0+4.*exp(1).^(sqrt(-1).*alpha.*(1+N1)+sqrt(-1).*omegal.*tau0+( ...
  2+N1).*s.*tau0).*(2+N1).*tau0+(-1).*exp(1).^(sqrt(-1).*alpha.*(2+ ...
  N1)+(sqrt(-1)*(1/2)).*omegal.*tau0+(3+N1).*s.*tau0).*(1+N1).*(3+ ...
  N1).*tau0+exp(1).^(sqrt(-1).*alpha.*(1+N1)+(4+N1).*s.*tau0).*N1.*( ...
  4+N1).*tau0+exp(1).^(sqrt(-1).*alpha.*N1+(sqrt(-1)*(3/2)).* ...
  omegal.*tau0+s.*tau0+N1.*s.*tau0).*((-1)+N1).*(tau0+N1.*tau0)+(-1) ...
  .*exp(1).^(sqrt(-1).*alpha.*N1+(sqrt(-1)*(1/2)).*omegal.*tau0+3.* ...
  s.*tau0+N1.*s.*tau0).*(1+N1).*(3.*tau0+N1.*tau0)).*(cos(alpha)+( ...
  -1).*cos((1/2).*omegal.*tau0+sqrt(-1).*s.*tau0)).^(-2)+(sqrt(-1)*( ...
  -1/4)).*exp(1).^((sqrt(-1)*(-1)).*alpha.*(1+N1)+(-1).*(sqrt(-1).* ...
  omegal+(2+N1).*s).*tau0).*gamma.*(exp(1).^((sqrt(-1)*(1/2)).*(4.* ...
  alpha.*(1+N1)+(omegal+N1.*omegal+(sqrt(-1)*(-6)).*s).*tau0))+exp( ...
  1).^((sqrt(-1)*(1/2)).*(4.*alpha.*N1+3.*omegal.*tau0+N1.*omegal.* ...
  tau0+(sqrt(-1)*(-2)).*s.*tau0))+exp(1).^((sqrt(-1)*2).*alpha+( ...
  sqrt(-1)*(1/2)).*(3+N1).*omegal.*tau0+s.*tau0)+(-2).*exp(1).^( ...
  sqrt(-1).*alpha+(sqrt(-1)*(1/2)).*(2+N1).*omegal.*tau0+2.*s.*tau0) ...
  +(-2).*exp(1).^(sqrt(-1).*alpha.*(1+2.*N1)+(sqrt(-1)*(1/2)).*(2+ ...
  N1).*omegal.*tau0+2.*s.*tau0)+exp(1).^((sqrt(-1)*(1/2)).*(1+N1).* ...
  omegal.*tau0+3.*s.*tau0)+4.*exp(1).^(sqrt(-1).*alpha.*(1+N1)+sqrt( ...
  -1).*omegal.*tau0+(2+N1).*s.*tau0)+exp(1).^(sqrt(-1).*alpha.*N1+( ...
  sqrt(-1)*(3/2)).*omegal.*tau0+s.*tau0+N1.*s.*tau0).*((-1)+N1)+exp( ...
  1).^(sqrt(-1).*alpha.*(2+N1)+(sqrt(-1)*(3/2)).*omegal.*tau0+(1+N1) ...
  .*s.*tau0).*((-1)+N1)+exp(1).^(sqrt(-1).*alpha.*(1+N1)+(4+N1).*s.* ...
  tau0).*N1+(-1).*exp(1).^(sqrt(-1).*alpha.*(1+N1)+((sqrt(-1)*2).* ...
  omegal+N1.*s).*tau0).*N1+(-1).*exp(1).^(sqrt(-1).*alpha.*N1+(sqrt( ...
  -1)*(1/2)).*omegal.*tau0+3.*s.*tau0+N1.*s.*tau0).*(1+N1)+(-1).* ...
...
function result = cetfun(tau0,N1,G,gamma,omegal,mu1,mu2,alpha,cx0,ce0,s)
    x1 = (sqrt(-1)*(-1)).*cx0.*G+ce0.*(sqrt(-1).*mu1+s+(1/8).*exp(1).^(( ...
  sqrt(-1)*(-1)).*alpha.*(1+N1)+(-1).*(sqrt(-1).*omegal+(2+N1).*s).* ...
  tau0).*gamma.*(exp(1).^((sqrt(-1)*(1/2)).*(4.*alpha.*(1+N1)+( ...
